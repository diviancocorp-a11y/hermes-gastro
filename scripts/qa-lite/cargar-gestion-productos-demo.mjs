...
const PRODUCTOS = [
  { id: '30000000-0000-4000-8000-000000000001', nombre: 'Clasica QA', categoriaOriginal: 'Principales', categoriaAnalisis: 'Bebidas', precio: 8500, stock: 12, unidades: [4, 6] },
  { id: '30000000-0000-4000-8000-000000000002', nombre: 'Verde QA', categoriaOriginal: 'Principales', categoriaAnalisis: 'Bebidas', precio: 7900, stock: 3, unidades: [4, 4] },
  { id: '30000000-0000-4000-8000-000000000003', nombre: 'Dulce QA', categoriaOriginal: 'Postres', categoriaAnalisis: 'Bebidas', precio: 4200, stock: 8, unidades: [1] },
  { id: '30000000-0000-4000-8000-000000000004', nombre: 'Bebida QA', categoriaOriginal: 'Bebidas', categoriaAnalisis: 'Bebidas', precio: 2500, stock: 0, unidades: [1] },
  { id: '30000000-0000-4000-8000-000000000901', nombre: 'Bife de chorizo (300g)', categoriaOriginal: 'Principales', categoriaAnalisis: 'Principales', precio: 18500, stock: 12, unidades: [4, 6] },
  { id: '30000000-0000-4000-8000-000000000900', nombre: 'Milanesa napolitana con papas', categoriaOriginal: 'Principales', categoriaAnalisis: 'Principales', precio: 12800, stock: 6, unidades: [4, 4] },
  { id: '30000000-0000-4000-8000-000000000902', nombre: 'Risotto de hongos', categoriaOriginal: 'Principales', categoriaAnalisis: 'Principales', precio: 11200, stock: 5, unidades: [1] },
  { id: '30000000-0000-4000-8000-000000000903', nombre: 'Pollo grillado con ensalada', categoriaOriginal: 'Principales', categoriaAnalisis: 'Principales', precio: 9800, stock: 2, unidades: [1] },
];
const TOTAL_VENTAS = PRODUCTOS.reduce((total, producto) => (
  total + producto.unidades.reduce((suma, cantidad) => suma + (producto.precio * cantidad), 0)
), 0);
...
const INGREDIENTES = [
  ...
  { id: '31000000-0000-4000-8000-000000000003', name: 'Crema dulce QA', cost: 100, stock: 12, min_stock: 3 },
  { id: '31000000-0000-4000-8000-000000000004', name: 'Bebida base QA', cost: 2200, stock: 0, min_stock: 1 },
  { id: '31000000-0000-4000-8000-000000000005', name: 'Base bife QA', cost: 5000, stock: 20, min_stock: 4 },
  { id: '31000000-0000-4000-8000-000000000006', name: 'Base milanesa QA', cost: 11500, stock: 20, min_stock: 4 },
  { id: '31000000-0000-4000-8000-000000000007', name: 'Base risotto QA', cost: 1000, stock: 12, min_stock: 3 },
  { id: '31000000-0000-4000-8000-000000000008', name: 'Base pollo QA', cost: 9000, stock: 8, min_stock: 2 },
];
...
if (LIMPIAR) {
  ...
  for (const producto of PRODUCTOS) {
    revisar((await admin.from('products').update({
      stock: null,
      category: producto.categoriaOriginal,
    }).eq('id', producto.id)).error, 'restaurar producto');
  }
...
for (const producto of PRODUCTOS) {
  revisar((await admin.from('products').update({
    ...
    category: producto.categoriaAnalisis,
  }).eq('id', producto.id)).error, 'cargar producto de prueba');
}
...
revisar((await admin.from('cash_sessions').upsert({
  ...
  closing_amount: 20000 + TOTAL_VENTAS,
  expected_amount: 20000 + TOTAL_VENTAS,
  difference: 0,
  status: 'closed',
...
for (const producto of PRODUCTOS) {
  for (const qty of producto.unidades) {
    ...
    const createdAt = new Date(
      new Date('2026-09-06T17:00:00-03:00').getTime() + (indice * 30 * 60 * 1000),
    ).toISOString();
    ordenes.push({
...
console.log(`[gestion-demo] ${ordenes.length} transacciones, ${items.reduce((s, item) => s + item.qty, 0)} unidades, ${PRODUCTOS.length} recetas y un turno cerrado`);
