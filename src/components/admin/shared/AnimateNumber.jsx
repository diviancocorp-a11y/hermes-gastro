// src/components/admin/shared/AnimateNumber.jsx
// Numero que transiciona digito a digito (estilo iOS .numericText()):
// SOLO los digitos que cambian se deslizan con blur; los demas quedan quietos.
// Ej: 1199 -> 1200 anima "99" -> "00" y el "12" no se mueve.
//
// Adaptado del componente "animated-blur-number" (TSX) al stack propio:
// JSX sin tipos, locale default es-AR (formato $1.234.567), cero dependencias.
// Los estilos se inyectan una sola vez en <head>.
//
// Uso:  <AnimateNumber value={monthSales} prefix="$" />
...
// Zero-width space: un slot vacio (digito que desaparecio) conserva line box
const ZWSP = "​";
...
function CharSlot({ char, direction, durationMs, blur }) {
  ...
  const [state, setState] = React.useState(() => ({ cur: char, out: null, gen: 0 }));
...
export function AnimateNumber({
  ...
  // Sube cuando el valor crece, baja cuando cae
