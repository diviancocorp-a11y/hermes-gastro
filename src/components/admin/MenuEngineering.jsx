...
const QUADRANT_META = {
  star:     { label: "STAR",     emoji: "⭐", color: "var(--ag-c-sales)",   bg: "var(--ag-c-sales-soft)",   advice: "Proteger. Promover sin tocar precio." },
  puzzle:   { label: "PUZZLE",   emoji: "🧩", color: "var(--ag-c-prep)",    bg: "var(--ag-c-prep-soft)",    advice: "Rentable pero vende poco. Marketing dirigido o reposicionar." },
  plowhorse:{ label: "PLOWHORSE",emoji: "🐴", color: "var(--ag-c-stock)",   bg: "var(--ag-c-stock-soft)",   advice: "Popular pero deja poco. Subir precio o bajar costo de plato." },
  dog:      { label: "DOG",      emoji: "🐶", color: "var(--ag-c-orders)",  bg: "var(--ag-c-orders-soft)",  advice: "Poco popular y poco rentable. Considerar sacar del menú." },
};
...
export default function MenuEngineering({
  ...
  const tabs = [
    ...
    { id: "star",      label: "⭐ Stars", count: counts.star,      color: QUADRANT_META.star.color },
    { id: "puzzle",    label: "🧩 Puzzles",count: counts.puzzle,    color: QUADRANT_META.puzzle.color },
    { id: "plowhorse", label: "🐴 Plowhorses", count: counts.plowhorse, color: QUADRANT_META.plowhorse.color },
    { id: "dog",       label: "🐶 Dogs",  count: counts.dog,        color: QUADRANT_META.dog.color },
  ];

  return (
    <div className="ag-card" style={{ padding: "14px 16px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
        <div style={{ fontSize: 13, fontWeight: 800, color: "var(--ag-ink)" }}>Menu Engineering · Kasavana</div>
      ...
      <p style={{ fontSize: 11, color: "var(--ag-ink-3)", margin: "4px 0 12px", lineHeight: 1.4 }}>
        Clasifica cada plato según popularidad y margen vs el promedio del menú. <strong>Stars</strong> protegé, <strong>Plowhorses</strong> subí precio, <strong>Puzzles</strong> empujá marketing, <strong>Dogs</strong> evaluá sacar.
      </p>
          ...
          return (
            ...
            >
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 6, fontSize: 11, color: "var(--ag-ink-2)" }}>
                ...
                <div>
                  <div style={{ fontSize: 9.5, color: "var(--ag-ink-3)", textTransform: "uppercase", letterSpacing: "0.05em" }}>Margen/u</div>
