...
//
// Props:
//   phoneSession: object | null  -> sesion phone-only activa
//   onSelect(tab): callback con la tab seleccionada (perfil/historial/etc).
//     Si null -> "iniciar sesion" (sin sesion previa).
//   onPhoneLogout(): callback al tocar "Cerrar sesion".
...
export default function AccountMenu({ phoneSession, onSelect, onPhoneLogout, align = "right" }) {
