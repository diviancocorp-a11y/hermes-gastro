...
export const MODULOS = {
  ...
  kds: {
    id: 'kds',
    label: 'Cocina',
    // La pantalla de produccion. NO reemplaza a `orders`: esa sigue siendo
    // la administrativa —aprobar, rechazar, cobrar, cancelar— y el KDS
    // recibe solo lo aprobado (migraciones 0072 y 0073).
    implementado: true,
  },
  finanzas: {
    id: 'finanzas',
