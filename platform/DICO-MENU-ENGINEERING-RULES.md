...
La card no abre otra pagina. Tiene dos estados internos:

1. `ranking`: resumen y filas de cuadrantes;
2. `producto`: perfil estadistico del producto elegido.
...
Las filas son Estrellas, Caballos, Enigmas, Perros y, cuando corresponda, En
observacion y Sin costo. Cada una muestra su cantidad. Una sola puede estar
abierta. Mobile nace con todas cerradas; desktop abre inicialmente la que
contenga la recomendacion mas urgente.
...
unidad y tendencia de posicion.
