...
Source: Canva `logo hermes` (DAHK631UKvY)
...
- 2 — Runner negro (solo ícono, fondo claro)
- 4 — Logo + nombre en negro (fondo claro)
- 5 — Logo + nombre en ámbar (fondo claro/oscuro)
- 6 — Logo + nombre mixto (ámbar + negro, fondo claro)
- 7 — Mockup wordmark 3 fondos (no usar como asset)
